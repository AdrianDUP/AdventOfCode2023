...
fn get_seed_destination(seed: u64, destination_start: u64, source_start: u64) -> u64 {
    println!("Difference in seed {} and source start {} is {}", seed, source_start, (seed - source_start));
...
fn is_seed_in_range(seed: u64, source_start: u64, source_end: u64) -> bool {
    return seed >= source_start && seed <= source_end;
}
